...
-- Note: this change provides an almost static system call speed of 1.2탎 regardless of the running process count
-- The old list, with 100 programs running required 4.5탎; with 200: 12탎; and with 300: 18탎 per syscall
